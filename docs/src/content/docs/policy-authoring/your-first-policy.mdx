...
export const STEP1_CODE = `import { createGateway } from "@homegrower-club/stoma";
...
export const STEP2_CODE = `import { createGateway, definePolicy, Priority } from "@homegrower-club/stoma";
...
export const STEP3_CODE = `import { createGateway, definePolicy, Priority } from "@homegrower-club/stoma";
...
1. **The minimal Policy object**
    ...
    - **`handler`** -- a standard Hono `MiddlewareHandler`.
